  ...
  return (
    <main className="min-h-screen">
      ...
      <Section className="max-w-3xl max-md:text-base text-lg">
        <div className="">
          Welcome to Life Advice, where we believe that good advice can
          transform your life. Our mission is to provide you with pratical
          advice to help you overcome life&apos;s challenges, achieve your
      ...
      <Section className="max-w-3xl text-lg">
        <div className="">
          {" "}
          This app is designed to have a real impact on your life. We&apos;ll
          help you:
        </div>
